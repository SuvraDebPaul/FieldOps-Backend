...
/**
 * Public: a customer needs this list to raise a request, so it is unauthenticated.
 * Inactive and soft-deleted categories are never returned.
 */
...
/** Soft delete — old service requests must still resolve their category. */
